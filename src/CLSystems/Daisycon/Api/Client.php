 ...
 *  add filter data as an array in the second parameter
...
class Client
{
	...
	/**
	 * Magic __call function that allows for partial path wise api calls for example
	 ...
	 * @throws Exception
	 * @see \CLSystems\DaisyconApi\Client::performCall
	 */
	 ...
	 * @param string $eRequestType
	 * @param array $aData
	 * @return null|stdClass
	 *@throws Exception if response header isn't valid
	 * @see \CLSystems\DaisyconApi\Client::handleResponse
	 */
